<div class="container">
    <div class="cover">
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-calendar" aria-hidden="true"></i> Tenants Yearly Sales </div>
        </div>
        <div class="well">
		                                ...
		                                <td>
	                                        <div class="btn-group"> 
	                                            <div class="img_menu">
	                                                ...
	                                                <ul style="position:absulote;left: -40px; top: -5px; background: white; border-top: none; z-index: 1000!important" class="dropdown-menu">
		                                                <li>
