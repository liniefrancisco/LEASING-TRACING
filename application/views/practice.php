        ...
        <div class="panel panel-default">
          <!-- Default panel contents -->
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" ng-controller="tableController" ng-init="loadList('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_leasee_type')">
                            <thead>
                                <tr>
                                    <th width="30%"><a href="#" data-ng-click="sortField = 'leasee_type'; reverse = !reverse">Lessee Type</a></th>
                                    <th width="50%"><a href="#" data-ng-click="sortField = 'description'; reverse = !reverse">Description</a></th>
                                    <?php if ($this->session->userdata('user_type') == 'Administrator'): ?>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#update_modal" ng-click="update('<?php echo base_url(); ?>index.php/leasing_mstrfile/get_leaseeType_data/' + type.id)"> <i class = "fa fa-edit"></i> Update</a></li>
                                                <li><a href="#" data-toggle="modal" data-target="#confirmation_modal" ng-click="delete('<?php echo base_url(); ?>index.php/leasing_mstrfile/delete_leaseeType/' + type.id)"> <i class = "fa fa-trash"></i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>    
                                    <?php endif ?>
    ...
    <div class="modal fade" id = "add_data">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="<?php echo base_url(); ?>index.php/leasing_mstrfile/add_leasee_type" name="add_form" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="validation-Error">
                                                <span ng-show="add_form.leasee_type.$dirty && add_form.leasee_type.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span ng-show="add_form.leasee_type.$dirty && add_form.leasee_type.$error.minlength">
                                                    <p class="error-display">Minimum of 3 characters</p>
                                                </span>
                                                <span ng-show="add_form.leasee_type.$dirty && add_form.leasee_type.$error.unique">
                    ...
                    <form  action = "{{ 'update_leaseeType/' + data.id }}" method="post" name = "frm_update" id = "frm_update">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="store_name" class="col-md-4 control-label text-right"><i class = "fa fa-asterisk"></i>Lessee Type</label>
                                        <div class="col-md-8">
                                            <input 
                                                type="text" 
                                                required 
                                            ...
                                            <!-- FOR ERRORS -->
                                            <div class="validation-Error">
                                                <span ng-show="frm_update.leasee_type.$dirty && frm_update.leasee_type.$error.required">
                                                    <p class="error-display">This field is required.</p>
                                                </span>
                                                <span ng-show="frm_update.leasee_type.$dirty && frm_update.leasee_type.$error.minlength">
                                                    <p class="error-display">Minimum of 5 characters</p>
                                                </span>
                                                <span ng-show="frm_update.leasee_type.$dirty && frm_update.leasee_type.$error.unique">
                                                    <p class="error-display">Data already exist.</p>
                                                </span>
                                            </div>  
                                        </div>
