<div class="container" >
    <div class="cover">
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-calendar" aria-hidden="true"></i> Tenant Monthly Sales Record</div>
        </div>
        <div class="well">
            <div class="upload-control">
                <div class="row">
                    <div class="row" id="tenant-record">  
                    	<form ng-submit="getDataList($base_url + 'tsms_controller/get_monthly_sales/' + tenant_list + '/' + trade_name + '/' + location_code + '/' + year, 'monthlySales')">
	                        <div class="col-md-2">
					        ...
					        <div class="col-md-2" >
						        <div class="form-group">
	                                <select
	                                  	...
	                                  	required
	                                  	ng-model="year">
	                                  	<option class="placeholder" selected disabled value="">Select Year</option>
	                                  	<option >All</option>
	                                  	<?php foreach (getValidYears() as  $year):?>
	                                  		<option ><?=$year;?></option>
	                                  	<?php endforeach; ?>
		                    ...
		                    <table class="table table-bordered table-hover">
		                        <thead>
		                            <tr>
		                                ...
		                                <th class="sort" ng-click="sort('date_end')" style="min-width:100px">Date End</th>
		                        ...
		                        <tbody >
		                            <tr ng-repeat= "data in monthlySales | filter:query | sortBy: field : reverse | tableOffset: page : ipp">
	                                            ...
	                                            <div class="img_menu">
	                                                ...
	                                                <ul style="position:absolute;left: -60px; top: -15px; background: white; border-top: none;" class="dropdown-menu">
		                                                ...
		                                                <?php if($this->session->userdata('user_type') == 'Administrator'): ?>
		                                                	<li>
		                                                		<a ng-click="deleteDataAjax($base_url + 'tsms_controller/delete_monthly_sale/' + data.id, 'monthlySales', data);"> <i class="fa fa-trash"></i> Delete</a>
		                                                	</li>
		                                              	<?php endif; ?>
	                                                </ul>
                                            </div>
		                            ...
		                            <tr class="ng-cloak" ng-show="!monthlySales || monthlySales.length == 0 || (monthlySales | filter:query).length == 0">
		                        ...
		                        <tfoot>
	                               <tr class="ng-cloak">
	                                  <td colspan="14">
	                                      <div>
	                                          <ul class="pagination" ng-show="paginate(monthlySales | filter:query | sortBy: field : reverse)">
...
<div id="view_modal_yearly" class="modal fade" role="dialog" aria-labelledby="tenant_daily_sales">
    <div class="modal-dialog modal-lg">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         <h4><i class="fa fa-search"></i> View Monthly Sale</h4>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label for="location_code" class="col-md-4 control-label text-right">Date End</label>
                                            <div class="col-md-8">
                                                <input 
                                                    type="text" 
                                                    required 
