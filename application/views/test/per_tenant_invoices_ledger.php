        ...
        <div class="">
            <div class="well" ng-init="getInitialData()">
                <div class="col-sm-12" style="padding-top: 20px;">
                    <a href="<?=base_url('/cntrl_tsms/per_tenant');?>" class="btn btn-primary">All Entries</a>
                    <a href="<?=base_url('/cntrl_tsms/per_tenant_invoices_ledger');?>" class="btn btn-success">Invoice Entries</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-12" style="padding-top: 20px;">
                        <form ng-submit="getGlData($event, 'tracing_controller/get_gl_receivable_invoices')" class="row">
                            <div class="col-md-2">
                                <input type="text" name="tenant_id" class="form-control" placeholder="Tenant ID">
                            </div>
                            <div class="col-md-3">
