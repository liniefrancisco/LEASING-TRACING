            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr class="ng-cloak"  ng-repeat="data in upload_status_list | filter:query | orderBy:sortField:reverse">
                            ...
                            <tr class="ng-cloak" ng-show="upload_status_list.length==0 || (upload_status_list | filter:query).length == 0">
