<div class="well" ng-controller="tablecontroller" ng-controller="decontroller" style="margin-top: 20px;margin-left: 10px;margin-right: 10px;">
    <div class="panel panel-default">
        <div class="panel-heading"><i class="fa fa-money" aria-hidden="true"></i> Pending Data Daily </div>
    </div>
    <div class="tabs">
           <ul class="nav nav-tabs">
            <li class="active"><a href="#menu1" data-toggle="tab" style="font-weight: bold;"> Pending Daily Sales </a></li>
           </ul>
            <br>
        <div class="table-transaction" id="table1">  
            <div class="tab-content">
                <div id="menu1" class="tab-pane fade in active">
                    <table class="table table-bordered" ng-controller="tablecontroller" ng-init="loadPending('<?php echo base_url(); ?>index.php/tsms_controller/get_pending_list')">
                        <thead>
                          <tr>
                            <th>Trade Name</th>
                            <th>Date</th>
                        ...
                        <tbody>
                          <tr ng-repeat="data in pendingList | filter:query">
                            <td>{{data.trade_name}}</td>
                            <td>{{data.transac_date}}</td>
                            <td>{{data.rental_type}}</td>
                            <td>{{data.total_net_sales }}</td>
                                ...
                                <div class="btn-group">
                                    <div class="img_menu">
                                        <img src="<?php echo base_url(); ?>img/menu3.png" style="height: 15px; width: 13px;" data-toggle="dropdown" id="img_menu">
                                            ...
                                            <li><a href="#" data-backdrop="static" title="View" data-keyboard="false" data-toggle="modal" data-target="#view_modal_daily" ng-click="update('<?php echo base_url(); ?>index.php/tsms_controller/get_pending_data/' + data.id)"> <i class = "fa fa-search"></i> View</a></li>
                                            <?php if($this->session->userdata('user_type') == 'Administrator'): ?>
                                            <li><a href="#" data-backdrop="static" title="Update" data-keyboard="false" data-toggle="modal" data-target="#update_modal_daily" ng-click="update('<?php echo base_url(); ?>index.php/tsms_controller/get_pending_data/' + data.id)"> <i class = "fa fa-edit"></i> Update</a></li>
                                            <?php endif ?>
                                            <li><a href="#" data-toggle="modal" title="Approve" data-target="#confirmation_modal2" ng-click="approve('<?php echo base_url(); ?>index.php/tsms_controller/approve_pending_items/' + data.id)"> <i class = "fa fa-thumbs-up"></i> Approve</a></li>
                                            <li><a href="#" data-toggle="modal" title="Disapprove" data-target="#confirmation_modal4" ng-click="disapprove('<?php echo base_url(); ?>index.php/tsms_controller/disapprove_pending_items2/' + data.id)"> <i class = "fa fa-thumbs-down"></i> Disapprove</a></li>
                                            </ul>
                                    </div>
                                </div>
                            </td> 
                            </tr>
                            <tr class="ng-cloak" ng-show="pendingList.length==0 || (pendingList | filter:query).length == 0">
...
<div id="view_modal_daily" class="modal fade" role="dialog" aria-labelledby="tenant_daily_sales">
    <div class="modal-dialog modal-lg">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         <h3><i class="fa fa-search"></i> View Pending Daily Sales</h3>
                </div>
...
<div id="update_modal_daily" class="modal fade" role="dialog" aria-labelledby="tenant_daily_sales">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         <h3><i class="fa fa-edit"></i> Update Pending Daily Sales</h3>
                </div>
                <div class="modal-body" ng-repeat="data in updateData">
